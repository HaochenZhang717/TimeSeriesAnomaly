...
python VarFlow.py \
  ...
  --ckpt_dir "none" \
  \
  --cond_eval_model_ckpt "../TSA-ckpts/VRF_v4/mitdb1800_213mixed/conditional_ckpt/ema_ckpt.pth" \
  --generated_path "../samples_path/vrf_v4/mitdb1800_213A" \
...
python VarFlow.py \
  ...
  \
  --cond_eval_model_ckpt "../TSA-ckpts/VRF_v4/mitdb1800_213mixed/conditional_ckpt/ema_ckpt.pth" \
  --generated_path "../samples_path/vrf_v4/mitdb1800_213V" \
  --generated_file "anomaly_cond_on_anomaly" \
  --normal_data_path "none" \
