...
python PrototypeFlow.py \
  ...
  \
  --ckpt_dir "../TSA-ckpts/PrototypeFlow/mitdb1800_106/normal_pretrain_len${SEQLEN}_ckpt" \
  \
  --generated_dir "none" \
  \
  --gpu_id 0
...
python PrototypeFlow.py \
  ...
  --ckpt_dir "../TSA-ckpts/PrototypeFlow/mitdb1800_106/normal_pretrain_len${SEQLEN}_ckpt" \
  \
  --generated_dir "../samples_path/PrototypeFlow/mitdb1800_106/normal_len${SEQLEN}" \
  \
  --gpu_id 0
...
#  --wandb_run "106npz-no-context" \
#  \
#  --ckpt_dir "../TSA-ckpts/PrototypeFlow/mitdb1800_106/no_context_len${SEQLEN}_ckpt" \
#  \
#  --generated_dir "none" \
#  \
#  --gpu_id 0
...
#  --ckpt_dir "../TSA-ckpts/PrototypeFlow/mitdb1800_106/no_context_len${SEQLEN}_ckpt" \
#  \
#  --generated_dir "../samples_path/PrototypeFlow/mitdb1800_106/no_context_len${SEQLEN}" \
#  \
#  --gpu_id 0
